...
use JaysonDev\Teletant\Entities\BotCommands;
use JaysonDev\Teletant\Entities\Chat;
use JaysonDev\Teletant\Entities\ChatMember;
use JaysonDev\Teletant\Entities\ChatMembers;
use JaysonDev\Teletant\Entities\File;
use JaysonDev\Teletant\Entities\GameHighScores;
use JaysonDev\Teletant\Entities\Message;
use JaysonDev\Teletant\Entities\Messages;
use JaysonDev\Teletant\Entities\Poll;
use JaysonDev\Teletant\Entities\StickerSet;
use JaysonDev\Teletant\Entities\Updates;
use JaysonDev\Teletant\Entities\User;
use JaysonDev\Teletant\Entities\UserProfilePhotos;
use JaysonDev\Teletant\Exception\TeletantException;
use JaysonDev\Teletant\Upload\InputFile;
use Closure;
